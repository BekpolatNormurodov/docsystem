...
export const sudReturns: Record<string, string> = {
  ...
  // Sudya boʻyicha hisobot (Boss + Sud formasi Excel 4-varaq)
  'Sudya boʻyicha': 'По судье',
  'Har 20 daqiqada avtomatik yangilanadi': 'Обновляется каждые 20 минут автоматически',
  'Ochish': 'Открыть',
  'Sudya': 'Судья',
  'Sud': 'Суд',
  'Kishi': 'Человек',
  ...
  '% qanoat': '% удов.',
  'Soʻnggi tinglash': 'Последнее слушание',
  'Hali sudya aniqlangan ish yo‘q. «Ulanishlar» dan cabinet.sud.uz ga ulanib detail sinxronlang.':
    'Пока нет дел с определённым судьёй. Подключитесь к cabinet.sud.uz из «Подключений» и синхронизируйте детали.',
  'Barchasini koʻrsatish': 'Показать все',
  'ta yana': 'ещё',
  'sudya': 'судей',
  'SUDYA BOʻYICHA': 'ПО СУДЬЕ',
  'ishda sudya aniqlangan': 'делах определён судья',
  // Sudya sinxron paneli
  'Sudya aniqlangan': 'Судья определён',
  'Sudyasi olinmagan': 'Судья не получен',
  'Soʻnggi sinxron': 'Последняя синхронизация',
  'Har': 'Каждые',
  'daqiqada firma boshiga': 'минут на фирму по',
  'ta ish avtomatik olinadi': 'дел загружается автоматически',
  'Kuchaytirilgan sinxron': 'Ускоренная синхронизация',
  'Bitta yo‘la 5 firma × 200 ta ish detali olinadi (cabinet rate-limit sabab ~5-6 soat)':
    'За один запуск: 5 фирм × 200 дел (из-за rate-limit cabinet ~5-6 часов)',
  'Boshlanmoqda…': 'Запускается…',
  'Sinxron ishlab turibdi': 'Синхронизация выполняется',
  'Sinxron boshlandi:': 'Синхронизация запущена:',
  'firma': 'фирм',
  'ish': 'дел',
  'taxminan': 'примерно',
  'soat': 'ч',
  'Sinxron allaqachon ishlab turibdi': 'Синхронизация уже выполняется',
  ...
  'hal qilingan': 'решено',
  'jami': 'всего',
  // Sudyalar Excel + sinxron boshqaruvi
  'Matritsa': 'Матрица',
  'Sud formasi': 'Судебная форма',
  'Sudyalar hisoboti — qanoat/qaytar kesimi bilan (Excel)': 'Отчёт по судьям — с разрезом удов./возвр. (Excel)',
  'Sudyalar hisoboti': 'Отчёт по судьям',
  'SUDYALAR HISOBOTI': 'ОТЧЁТ ПО СУДЬЯМ',
  'Sudyalar': 'Судьи',
  'Kuchaytirilgan sinxron ketmoqda': 'Ускоренная синхронизация идёт',
  'olingan': 'получено',
  'daq': 'мин',
  'To‘xtatish': 'Остановить',
  'Qayta boshlash': 'Перезапустить',
  'Keyingi firma oldidan to‘xtaydi': 'Остановится перед следующей фирмой',
  'Turib qolgan bo‘lsa — qulfni tozalab yangidan boshlaydi': 'Если зависла — снимет блокировку и начнёт заново',

...
export const sudReturns: Record<string, string> = {
  ...
  'Sudya bo‘yicha — Jami · Qanoat. · Qaytar. · %': 'По судье — Всего · Удов. · Возвр. · %',
  'ishda sudya aniqlangan': 'делах определён судья',
  'ta sudya · ochish': 'судей · открыть',
  'Sudya': 'Судья',
  'Sud': 'Суд',
  'Kishi': 'Человек',
  'Jami ish': 'Всего дел',
  ...
  '% qanoat': '% удов.',
  'So‘nggi tinglash': 'Последнее слушание',
  ...
  'Barchasini ko‘rsatish': 'Показать все',
  'ta yana': 'ещё',
  'sudya': 'судей',
  'SUDYA BOʻYICHA': 'ПО СУДЬЕ',
  'ishda sudya aniqlangan (cabinet detail)': 'делах определён судья (cabinet detail)',

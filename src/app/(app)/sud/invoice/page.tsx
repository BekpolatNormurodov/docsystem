...
export default async function SudInvoicePage() {
  ...
  return (
    <div className="space-y-4">
      <div>
        <h1 className="text-2xl font-bold tracking-tight">{t('Invoice yaratish')}</h1>
        <p className="mt-1 max-w-3xl text-sm text-muted">
          {t("Har mijozga davlat boji invoice'i billing.sud.uz dan yaratiladi (raqam + PDF), arizasiga bogʻlanadi va buxgalterga ZIP (PDF'lar + Hisobot.xlsx) boʻlib beriladi. Har firma alohida, bir martada ≤100 ta. Toʻlangach invoice raqami ariza bilan sudga ketadi.")}
        </p>
      </div>

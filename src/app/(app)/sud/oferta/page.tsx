...
export default async function SudOfertaPage() {
  ...
  return (
    <div className="space-y-4">
      <div>
        <h1 className="text-2xl font-bold tracking-tight">{t('Oferta tayyorlash')}</h1>
        <p className="mt-1 max-w-3xl text-sm text-muted">
          {t('Har mijozning har shartnomasiga oferta (mikroqarz shartnomasi) PDF yaratiladi va bitta ZIP (mijoz papkalari) boʻlib beriladi. Firma boʻyicha yoki umumiy · hammasi yoki belgilangan son.')}
        </p>
      </div>

...
export function TalabnomaStat({ snapshotId }: { snapshotId?: number }) {
  ...
  const download = async () => {
    ...
    try {
      ...
      if (!res.ok) { let e = t('Statistika yaratilmadi'); try { e = (await res.json()).error || e; } catch {} throw new Error(e); }
